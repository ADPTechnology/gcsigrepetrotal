...
@section('modals')
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('wastes.store') }}" id="registerWasteClassForm" method="POST"
                    data-validate='{{ route('wastes.validateSymbol') }}'>
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6" id="selectGroup">
                                <label> Grupo *</label>
                                <select name="group_id" class="form-control select2" id="registerGroupSelect">
                                </select>
                            </div>
                            <div class="form-group col-md-6" id="selectStatus">
                                <label> Estado *</label>
                                <select name="status_id" class="form-control select2" id="registerStatusSelect">
                                </select>
                            </div>
                        </div>
                ...
                <form action="" id="EditWasteClassForm" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label> Grupo *</label>
                                <select name="group_id" class="form-control select2" id="editGroupSelect">
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                <label> Estado *</label>
                                <select name="status_id" class="form-control select2" id="editStatusSelect">
                                </select>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="RegisterGroupModal" tabindex="-1" aria-labelledby="RegisterGroupModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
    ...
    <div class="modal fade" id="RegisterWasteModal" tabindex="-1" aria-labelledby="RegisterWasteModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
    ...
    <div class="modal fade" id="RegisterStatusModal" tabindex="-1" aria-labelledby="RegisterStatusModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
