...
@section('modals')
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('warehouses.store') }}" id="registerWarehouseForm" method="POST"
                    data-validate="{{ route('warehouses.validateName') }}">
                    @csrf
                    <div class="modal-body">

                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputProfile">Nombre *</label>

                                <div class="input-group">
                                    <input type="text" name="name" class="form-control"
                                        placeholder="Ej: COMEDOR-Newrest">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Código *</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="activity" class="form-control select2" id="registerActivitySelect">
                                    <option value=""></option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="id_lot" class="form-control select2" id="registerLotSelect">
                                    <option value=""></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="id_location" class="form-control select2" id="registerLocationSelect"
                                    required>
                                    <option value=""></option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputProfile">Área*</label>

                                <select name="id_project_area" class="form-control select2" id="registerProjectSelect">
                                    <option value=""></option>
                                </select>
                            </div>
                            ...
                            {{-- <div class="form-group col-md-6">
                                ...
                                <select name="id_stage" class="form-control select2" id="registerStageSelect">
                                    <option value=""></option>
                                </select>
                            </div> --}}
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="id_company" class="form-control select2" id="registerCompanySelect">
                                    <option value=""></option>
                                </select>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="id_front" class="form-control select2" id="registerFrontSelect">
                                    <option value=""></option>
                                </select>
                            </div>
                        </div> --}}
    ...
    <div class="modal fade" id="EditWarehouseModal" data-context='' tabindex="-1" aria-labelledby="EditWarehouseModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <form action="" id="editWarehouseForm" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Actividad *</label>
                                <select name="activity" class="form-control select2" id="editActivitySelect">
                                    <option value=""></option>
                                    @foreach ($activities as $key => $activity)
                                        <option value="{{ $key }}">{{ $activity }}</option>
                                    @endforeach
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="id_lot" class="form-control select2" id="editLotSelect" required>
                                    <option value=""></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="id_location" class="form-control select2" id="editLocationSelect" required>
                                    <option value=""></option>
                                </select>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="editProjectSelect">Área*</label>

                                <select name="id_project_area" class="form-control select2" id="editProjectSelect"
                                    required>
                                    <option value=""></option>
                                </select>
                            </div>
                            {{-- <div class="form-group col-md-6">
                                ...
                                <select name="id_stage" class="form-control select2" id="editStageSelect" required>
                                    <option value=""></option>
                                </select>
                            </div> --}}
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="id_company" class="form-control select2" id="editCompanySelect" required>
                                    <option value=""></option>
                                </select>
                            </div>
                        ...
                        {{-- <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="id_front" class="form-control select2" id="editFrontSelect" required>
                                    <option value=""></option>
                                </select>
                            </div>
                        </div> --}}
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input id="inputName" type="text" name="elementName"
                                        class="form-control name required-input" placeholder="">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    {{-- <div class="modal fade" id="RegisterStagesModal" data-context='' tabindex="-1"
        aria-labelledby="RegisterStagesModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" id="inputStageName" name="elementName"
                                        class="form-control name" placeholder="Nombre de etapa" required>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="EditLocationModal" tabindex="-1" aria-labelledby="EditLocationModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" id="inputLocationName" name="elementName"
                                        class="form-control name" placeholder="Nombre de locación" required>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="RegisterProjectsModal" data-context='' tabindex="-1"
        aria-labelledby="RegisterProjectsModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" id="inputProjectName" name="elementName"
                                        class="form-control name" placeholder="Nombre de área de proyecto" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input id="inputRuc" type="text" name="ruc"
                                        class="form-control name required-input" placeholder="Número de RUC">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" id="inputCompanyName" name="elementName"
                                        class="form-control name" placeholder="Nombre de empresa" required>
                                </div>
                            </div>
                        </div>
    ...
    {{-- <div class="modal fade" id="RegisterFrontsModal" data-context='' tabindex="-1"
        aria-labelledby="RegisterFrontsModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" id="inputFrontName" name="elementName"
                                        class="form-control name" placeholder="Nombre de frente" required>
                                </div>
                            </div>
                        </div>
                    </div>
