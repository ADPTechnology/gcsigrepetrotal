    ...
    <div class="modal fade" id="RegisterUserModal" tabindex="-1" aria-labelledby="RegisterUserModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="{{ route('users.store') }}" enctype="multipart/form-data" id="registerUserForm"
                    method="POST">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row" id="selects-container-register">
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputPhone">Celular (opcional)</label>
                                <div class="input-group">
                            ...
                            <div class="form-group col-12">
                                ...
                                <div id="select-company-container-register">
                                    <select data-url="" name="id_user_company" class="form-control select2"
                                        id="registerCompanySelect" required>
                                        <option></option>
                                    </select>
                                </div>
                        ...
                        {{-- <div class="form-group row mb-4">
                            <label class="col-form-label col-12 col-md-3 col-lg-3">Subir firma <span
                                    class="col-form-label info-signature-required">*</span> </label>
                            <div class="col-12">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input id="inputUserName" type="text" name="username"
                                        class="form-control user-name" placeholder="Nombre de usuario" required>
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <i class="fa-solid fa-user"></i>
                                        </div>
                        ...
                        {{-- <div class="form-group row mb-4">
                            ...
                            <div class="col-12">
                                <div id="image-preview" class="image-preview">
                                    ...
                                    <div class="img-signature-holder">
                                        <img id="image-signature-edit" src="" alt=""
                                            class="img-fluid signature_img">
                                    </div>
                                </div>
                            </div>
                        </div> --}}
