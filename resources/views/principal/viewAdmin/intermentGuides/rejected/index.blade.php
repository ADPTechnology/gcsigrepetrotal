        ...
        <div class="title-page-header">
            ...
            <div class="principal-container card-body card z-index-2">
                ...
                <div class="d-flex">
                    ...
                    <form action="{{ route('internmentGuidesRejected.export') }}" id="form-guides-rejected-export"
                        method="GET">
                ...
                <table id="guide-rejected-table-admin" class="table table-hover"
                    data-url="{{ route('guidesAdmin.index') }}">
                    <thead>
