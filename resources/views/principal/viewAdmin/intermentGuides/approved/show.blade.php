                ...
                <div class="mb-4">
                    ...
                    <div class="form-row" id="selects-container-register-guide">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input value="{{ $guide->warehouse->stage->name }}" id="guide-stage-dis" type="text"
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input value="{{ $guide->warehouse->location->name }}" id="guide-location-dis" type="text"
                                class="form-control" disabled>
                        </div>

                        <div class="form-group col-md-2">
                            <span class="guide-warehouse-info-dis">ÁREA / PROYECTO</span>
                            <input value="{{ $guide->warehouse->projectArea->name }}" id="guide-proyect-dis" type="text"
                                class="form-control" disabled>
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input value="{{ $guide->warehouse->company->name }}" id="guide-company-dis" type="text"
                                class="form-control" disabled>
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input value="{{ $guide->warehouse->front->name }}" id="guide-front-dis" type="text"
                                class="form-control" disabled>
                        </div>
                        ...
                        <div class="info-user-box-guide info-applicant-container">
                            ...
                            <div class="personal-info-user">
                                ...
                                <div class="row-user-info-guide">
                                    ...
                                    <div class="row-user-info-txt">
                                        <form action="{{ route('guidesAdmin.updateDate', $guide) }}" id="update-guide-form"
                                            class="update-guide-form" method="POST">
                                            <div class="input-group">
                                                <input type="date" required class="form-control" name="date"
                                                    value="{{ getOnlyDate($guide->created_at) }}">
                                                <div class="input-group-append">
                                                    <button class="btn btn-outline-primary" type="submit">
                                                        <i class="ti ti-device-floppy fa-lg"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
