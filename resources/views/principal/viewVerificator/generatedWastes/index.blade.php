    ...
    <div class="row content">
        ...
        <div class="title-page-header">
            ...
            <div class="principal-container card-body card z-index-2">
                ...
                <div class="form-group date-range-container">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <a href="javascript:;" id="daterange-btn-wastes-verificator"
                                class="btn btn-primary icon-left btn-icon pt-2">
                                <i class="fas fa-calendar"></i>
                                Elegir Fecha
                            </a>
                        </div>
                        <input id="date-range-input-wastes-verificator" type="text" name="date-range"
                            class="form-control date-range-input" disabled>
                    </div>
                </div>

                <div class="d-flex" id="form-generated-wastes-verificator-container">

                    <form action="{{ route('generatedWastesVerificator.export') }}" id="form-generated-wastes-export"
                        method="GET">
                ...
                <table id="generated-wastes-table-verificator" class="table table-hover"
                    data-url="{{ route('generatedWastesVerificator.index') }}">
                    <thead>
                        <tr>
                            <th>N°</th>
