    ...
    <div class="title-page-header">
        ...
        <div class="principal-container card-body card z-index-2">
            ...
            <div class="mb-4 buttons-register-container">
                <div id="btn-register-arrival-container" data-url="{{ route('getDepartureDetails.manager') }}">
                ...
                <div id="btn-register-departure-container" data-url="{{ route('getWastesDepartureDetail.ajax') }}">
                    <div class="btn btn-secondary" style="pointer-events: none;">
                        <i class="ti ti-square-rounded-plus-filled"></i> &nbsp;
                ...
                <div class="form-group">
                    ...
                    <div class="selectgroup">
                        <label class="selectgroup-item">
                            <input type="radio" name="filter-departures-stat-arrival" value=""
                                class="selectgroup-input" checked>
                            <span class="selectgroup-button selectgroup-button-icon">TODO</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="filter-departures-stat-arrival" value="pendiente"
                                class="selectgroup-input">
                            <span class="selectgroup-button selectgroup-button-icon">PENDIENTE</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="filter-departures-stat-arrival" value="gestionado"
                                class="selectgroup-input">
            ...
            <div class="group-filter-buttons-section">
                ...
                <div class="form-group col-2 p-0 select-group">
                    ...
                    <div>
                        <select name="ppc_guide_select" id="ppc_guide_select" class="form-control select2">
                            <option></option>
                ...
                <div class="form-group col-2 p-0 select-group">
                    ...
                    <div>
                        <select name="manifest_select" class="form-control select2" id="manifest_select">
                            <option></option>
                ...
                <div class="form-group col-2 p-0 select-group">
                    ...
                    <div>
                        <select name="waste_departure_select" class="form-control select2" id="waste_departure_select">
                            <option></option>
                ...
                <div class="form-group col-2 p-0 select-group">
                    ...
                    <div>
                        <select name="transport_select" class="form-control select2" id="transport_select">
                            <option></option>
                            @foreach ($shippingCollect as $item)
                                <option value="{{ $item->shipping_type ?? '-' }}">{{ $item->shipping_type ?? '-' }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-group col-2 p-0 select-group">
                    ...
                    <div>
                        <select name="destination_select" class="form-control select2" id="destination_select">
                            <option></option>
                ...
                <div class="form-group col-2 p-0 select-group">
                    ...
                    <div>
                        <select name="guide_gc_select" class="form-control select2" id="guide_gc_select">
                            <option></option>
                ...
                <div class="form-group col-2 p-0 select-group">
                    ...
                    <div>
                        <select name="waste_name_select" class="form-control select2" id="waste_name_select">
                            <option></option>
            ...
            <div>
                <div class="form-group col-1 p-0 mt-2">
                    ...
                    <input data-url="{{ route('getWastesTotalWeight.manager') }}" class="form-control disabled"
                        id="total_weight_count_departure" type="text" readonly
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" name="date-arrival" class="form-control datetimepicker"
                                        required>
                                    <div class="input-group-prepend">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" name="date-retreat" class="form-control datetimepicker"
                                        required>
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <i class="fa-solid fa-calendar-days"></i>
