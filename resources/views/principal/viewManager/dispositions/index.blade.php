    ...
    <div class="title-page-header">
        ...
        <div class="principal-container card-body card z-index-2">
            ...
            <div class="mb-4 buttons-register-container">
                <div id="btn-register-disposition-container" data-url="{{ route('getWastesDetail.ajax') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="selectgroup">
                        <label class="selectgroup-item">
                            <input type="radio" name="filter-departures-stat-disposition" value=""
                                class="selectgroup-input" checked>
                            <span class="selectgroup-button selectgroup-button-icon">TODO</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="filter-departures-stat-disposition" value="pendiente"
                                class="selectgroup-input">
                            <span class="selectgroup-button selectgroup-button-icon">PENDIENTE</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="filter-departures-stat-disposition" value="gestionado"
                                class="selectgroup-input">
            ...
            <div class="group-filter-buttons-section">
                ...
                <div class="form-group col-2 p-0 select-group">
                    ...
                    <div>
                        <select name="guide_gc_select" id="guide_gc_select" class="form-control select2">
                            <option></option>
                            @foreach ($guideGcCollection as $item)
                                <option value="{{ $item->code_green_care ?? '-' }}">{{ $item->code_green_care ?? '-' }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-group col-2 p-0 select-group">
                    ...
                    <div>
                        <select name="plate_select" class="form-control select2" id="plate_select">
                            <option></option>
            ...
            <div>
                <div class="form-group col-1 p-0 mt-2">
                    ...
                    <input data-url="{{ route('getWastesTotalWeight.manager') }}" class="form-control disabled"
                        id="total_weight_count_disposition" type="text" readonly
    ...
    <div class="modal fade" id="RegisterDispositionModal" tabindex="-1" aria-labelledby="RegisterDispositionModal"
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-wastes">
            <div class="modal-content">
                ...
                <form action="{{ route('managerWastesDisposition.update') }}" id="register-disposition-form"
                    method="POST">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="ddff-weight" class="form-control" min="0"
                                    step="0.01" required>
                            </div>

                            <div class="form-group col-md-4">
                                <label for="inputVolume">Peso Parihuela - Contenedor *</label>
                                <input type="number" name="weight-diff" class="form-control" min="0"
                                    step="0.01" placeholder="Ingresar parihuela - contenedor" required>
                            </div>
