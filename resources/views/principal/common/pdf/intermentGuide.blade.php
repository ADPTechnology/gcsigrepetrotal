            ...
            <div class="left-header-cont">
                ...
                <div class="date-cont">
                    ...
                    <span class="date">
                        ...
                        @endphp
                        {{ utf8_encode(strftime('%A %e de %B, %Y %H:%M', time())) }}
            ...
            <div class="users-container">
                <div class="container-users top-container-users not-page-break">
                    ...
                    <div class="row-div first-row-div float-left">
                        ...
                        <div class="img-signature-cont border-custom">
                            @if (($guide->applicant->url_signature ?? '') != '')
                            @php
                                $encode = null;
                                try {
                                    $encode = base64_encode(file_get_contents(base_path('public/storage/'.$guide->applicant->url_signature??'')));
                                } catch (Exception $e) {
                                    $encode = false;
                                }
                            @endphp
                    ...
                    <div class="row-div second-row-div float-right" style="clear: both">
                        ...
                        <div class="img-signature-cont border-custom">
                            ...
                            @if (($guide->reciever->url_signature ?? '') != '')
                            @php
                                $encode2 = null;
                                try {
                                    $encode2 = base64_encode(file_get_contents(base_path('public/storage/'.$guide->reciever->url_signature)));
                                } catch (Exception $e) {
                                    $encode2 = false;
                                }
                            @endphp
                ...
                <div class="container-users bottom-container-users not-page-break" style="clear: both">
                    ...
                    <div class="row-div first-row-div float-left">
                        ...
                        <div class="img-signature-cont border-custom">
                            @if ((($guide->approvant->url_signature ?? '') != '') && $guide->stat_approved == 1)
                            @php
                                $encode3 = null;
                                try {
                                    $encode3 = base64_encode(file_get_contents(base_path('public/storage/'.$guide->approvant->url_signature)));
                                } catch (Exception $e) {
                                    $encode3 = false;
                                }
                            @endphp
                    ...
                    <div class="row-div second-row-div float-right">
                        ...
                        <div class="img-signature-cont border-custom">
                            @if (($guide->checker->url_signature ?? '') != '')
                            @php
                                $encode4 = null;
                                try {
                                    $encode4 = base64_encode(file_get_contents(base_path('public/storage/'.$guide->checker->url_signature)));
                                } catch (Exception $e) {
                                    $encode4 = false;
                                }
                            @endphp
