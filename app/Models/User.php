...
use App\Models\{Role, IntermentGuide, Company, OwnerCompany};
...
class User extends Authenticatable
{
    ...
    public function approvantPreviousGuides()
    {
        return $this->belongsToMany(IntermentGuide::class, 'guide_has_approvants', 'approvant_id', 'guide_id')->withTimestamps();
    }
